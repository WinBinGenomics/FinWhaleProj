...
# Example: Rscript --vanilla step0_vcf2gds_all50_20210316.R 'directory' 'JointCalls_all70_08_B_VariantFiltration' 'outdir'

# Adjusted / modified by Kaden Winspear @ CSUSM. Analyzing eastern pacific fin whales project.
# Date: April 2025
...
out.fn <- paste0(vcfprefix, "_biallelic_all.gds")

print(vcffiles)

# get the population names
popmap = read.csv(file = '/data/shared/snigenda/finwhale_projects/scripts/winfingenomics/config/all70_fin_popmap.csv', stringsAsFactor = FALSE) # for all 70 data
...
# There are four possible values stored in the variable genotype: 0, 1, 2 and 3. For bi-llelic SNP sites, “0” indicates two B alleles, “1” indicates one A allele and one B allele, “2” indicates two A alleles, and “3” is a missing genotype. Note: "0" --> "1/1"; "1" --> "0/1"; "2" --> "0/0"; "3" --> "./."
