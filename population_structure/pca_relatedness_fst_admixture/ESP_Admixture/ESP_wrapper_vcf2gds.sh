...
WORKSCRIPT="${HOMEDIR}/scripts/winfingenomics/population_structure/pca_relatedness_fst_admixture/ESP_Admixture/ESP_vcf2gds.R"

####### The input files ########
VCFDIR="${HOMEDIR}/fin_genomics/PopStructure/ESP_admixture"
VCFPREFIX="LDPruned_maf05_SNPs.ESPOnly"
