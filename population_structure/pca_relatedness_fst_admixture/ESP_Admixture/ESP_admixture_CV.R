...
cat("\014")
options(echo = TRUE)
setwd("/data/shared/snigenda/finwhale_projects/fin_genomics/PopStructure/ESP_admixture/plots")
...
adcv = read.csv(file = paste0("/data/shared/snigenda/finwhale_projects/fin_genomics/PopStructure/ESP_admixture/Admixture_20250807/maf05/Admixture_CV_ESPOnly_LLsummary_maf05.csv"), stringsAsFactors = FALSE)
...
write.csv(forplot, file = '/data/shared/snigenda/finwhale_projects/fin_genomics/PopStructure/ESP_admixture/derive_data/ESP_admixtureCV.csv')
