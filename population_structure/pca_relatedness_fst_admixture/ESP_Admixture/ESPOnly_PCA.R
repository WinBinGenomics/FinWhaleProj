...
# load data --------
# final gdf file used
gdspath = "/data/shared/snigenda/finwhale_projects/fin_genomics/PopStructure/ESP_admixture/LDPruned_maf05_SNPs.ESPOnly_biallelic_all.gds"
genofile <- snpgdsOpen(gdspath, readonly = TRUE)
popmap = read.csv(file = "/data/shared/snigenda/finwhale_projects/scripts/winfingenomics/config/ESP_popmap.csv", stringsAsFactors = F)
...
# main --------
ENPids = sampleids[popmap$PopId %in% c('ESP')]
...
write.csv(tab, file = '/data/shared/snigenda/finwhale_projects/fin_genomics/PopStructure/ESP_admixture/derive_data/PCA_results.csv')
