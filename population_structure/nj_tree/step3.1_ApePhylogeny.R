...
# Title: Use the ape neighbor joining tree to construct phylogeny (For use in CSUSM cluster for bootstrapping, no ggplotting part)
...
#popmap = read.csv(file = '/data/shared/snigenda/finwhale_projects/scripts/winfingenomics/config/all70_fin_popmap.csv', stringsAsFactor = FALSE) # all70 Individual
popmap = read.csv(file = '/data/shared/snigenda/finwhale_projects/scripts/winfingenomics/config/DemoPassInds_fin_popmap.csv', stringsAsFactor = FALSE) 
