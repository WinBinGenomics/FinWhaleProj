...
# load data --------
bcfroh = readRDS(file = './derived_data/ROH_bcfroh_summary_final_20250602.rds')
zooroh = readRDS(file = './derived_data/ROH_zooroh_summary_final_20250602.rds')
genomehet = read.csv(file = '/data/shared/snigenda/finwhale_projects/fin_genomics/diversity/genomewide_diversity/autosomalwide_estimates/all70_genomewide_autosomal_heterozygosity_20250404.csv',
...
pairwise.wilcox.test(rohsum2$N_zoo_all, rohsum2$PopId, p.adjust.method = "bonferroni")
