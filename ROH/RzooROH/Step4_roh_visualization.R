...
# Adjusted by Kaden Winspear for Eastern pacific fin whale project @ CSUSM | May 1st 2025
...
setwd("/data/shared/snigenda/finwhale_projects/fin_genomics/ROH/RZOOROH")
source("/data/shared/snigenda/finwhale_projects/scripts/winfingenomics/ROH/RzooROH/PlotFunctions/zooplot_prophbd_v1.R")
source("/data/shared/snigenda/finwhale_projects/scripts/winfingenomics/ROH/RzooROH/PlotFunctions/zooplot_reverse_v2.R")
source("/data/shared/snigenda/finwhale_projects/scripts/winfingenomics/ROH/RzooROH/PlotFunctions/zooplot_individuals_v1.R")


#Colors
pops <- c("ENP","GOC","ESP") 
# right after you set `pops <- c("ENP","GOC","ESP")`
mycols <- c(
  ENP = "#1b9e77",  
  GOC = "#d95f02",   
  ESP = "#7570b3"    
...
popResultsList=list(ENP=ENP_results,GOC=GOC_results,ESP=ESP_results)

pdf(paste0(model,"_pops.pdf"))
zooplot_prophbd_v1(popResultsList,style='barplot',cols = mycols)
...
grop <- function(group, color){
  ...
  zooplot_prophbd_v1(popResultsList[[group]], cols = mycols[group], style = 'boxplot')
