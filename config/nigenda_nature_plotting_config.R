...
mycolors = RColorBrewer::brewer.pal(n = 3, name = "Dark2")[1:2:3]
#mycolors = c("#1B9E77","#D95F02","#E41A1C")
names(mycolors) = mypops

mylocs = c("AK", "BC", "CA", "OR", "WA", "GOC", "ESP")
loccolors = RColorBrewer::brewer.pal(n = 8, name = "Dark2")[c(3:7,2)]
#loccolors = c("#7570B3","#E7298A","#66A61E","#E6AB02","#A6761D","#D95F02","#E41A1C")
names(loccolors) = mylocs
subpoporder = c("AK", "BC", "WA", "OR", "CA", "GOC", "ESP") # order for subpopulations
