#!/bin/bash
#SBATCH --job-name=fscWrapperESP
#SBATCH --output=/data/shared/snigenda/finwhale_projects/scripts/winfingenomics/demographic_inference/fsc26/1DModels/reports/fscwrapperESP.%A_%a.out.txt
#SBATCH --error=/data/shared/snigenda/finwhale_projects/scripts/winfingenomics/demographic_inference/fsc26/1DModels/reports/fscwrapperESP.%A_%a.err.txt
...
# Updated / modified by Kaden Winspear @ CSUSM for SLURM + Eastern Pacific fin whale project.
# Usage: sbatch fsc_wrapper_ESP.sh
...
models='1D.3Epoch.ESP.ncur100_15000'
pops="ESP"
cores=8
ss="34"
version="Normal"
