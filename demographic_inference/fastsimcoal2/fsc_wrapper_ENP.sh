#!/bin/bash
#SBATCH --job-name=fscWrapperENP
#SBATCH --output=/data/shared/snigenda/finwhale_projects/scripts/winfingenomics/demographic_inference/fsc26/1DModels/reports/fscwrapperENP.%A_%a.out.txt
#SBATCH --error=/data/shared/snigenda/finwhale_projects/scripts/winfingenomics/demographic_inference/fsc26/1DModels/reports/fscwrapperENP.%A_%a.err.txt
...
# Usage: sbatch fsc_wrapper_ENP.sh
...
genericDir=/data/shared/snigenda/finwhale_projects/scripts/winfingenomics/demographic_inference/fsc26/1DModels
sfsDir=/data/shared/snigenda/finwhale_projects/fin_genomics/demographic_inference/SFS/Neutral/SFS_projection_fsc
# sfsDir=/u/home/p/pnunez/project-rwayne/FinWhale/fastsimcoal/optimization_tryout

# Programs -------------------------
# Parameters -----------------------

models='1D.4Epoch.EXPANDED'
pops="ENP"
cores=8
ss="46"
version="Normal"
...
do
	...
	do
		...
		#fsc26 -t ${model}.tpl -n 1000000 -m -e ${model}.est -M -L 60 -c ${cores} -q
