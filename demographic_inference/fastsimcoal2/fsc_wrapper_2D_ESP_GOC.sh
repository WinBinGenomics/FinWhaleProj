...
genericDir=/data/shared/snigenda/finwhale_projects/scripts/winfingenomics/demographic_inference/fsc26/2DModels
sfs=/data/shared/snigenda/finwhale_projects/fin_genomics/demographic_inference/SFS/Neutral/SFS_projection_fsc/ESP-GOC_jointMAFpop1_0.obs

# Parameters -----------------------
pops='ESP-GOC'
models='AncestralSizeChange-Split-AsymmetricMigration'
cores=8
version="Normal"
