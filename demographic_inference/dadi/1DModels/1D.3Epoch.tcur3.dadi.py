...
output=[popt_str,scaled_popt_str,theta,ll_model,ll_data,func.__name__,mu,L,maxiter,runNum,todaysdate,p0,upper_bound,lower_bound] # put all the output terms together + adfunc.__name__
