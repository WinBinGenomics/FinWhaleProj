...
output=[scaled_popt_str,theta,ll_model,ll_data,func.__name__,mu,L,maxiter,runNum,todaysdate] # put all the output terms together, changing func.func_name to func.__name__
