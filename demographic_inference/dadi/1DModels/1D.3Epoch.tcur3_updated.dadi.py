import matplotlib
matplotlib.use('Agg')  # So plots render on remote servers
import sys
import argparse
import dadi
...
# === Model function with tcur = 3 generations ago ===
Nanc_fixed = 15100
tcur = 3 / (2 * Nanc_fixed)  # ~ 9.51e-5 = ENP, 9.93e-5
...
def bottleneck(params, ns, pts):
    ...
    phi = Integration.one_pop(phi, xx, tcur, nuF)    # recovery exactly 3 generations ago
...
TF_scaled_gen = tcur * 2 * Nanc  # should = 3 generations
