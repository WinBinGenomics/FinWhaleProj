...
parser.add_argument("--pop",required=True,help="population identifier, e.g. 'ENP/GOC/ESP' or 'Vaquita'")
...
# Define bounds first
#upper_bound = [1.6, 0.05, 0.16, 8e-5]
#lower_bound = [1.4, 0.075, 0.13, 4e-5]
#p0 = [1.4, 0.01, 0.14, 5e-5]

upper_bound = [10, 10, 1, 9e-5]
lower_bound = [1e-4, 1e-4, 1e-5, 3e-5]
p0 = [1.4, 0.02, 0.13, 6e-5]
...
output=[popt_str,scaled_popt_str,theta,ll_model,ll_data,func.__name__,mu,L,maxiter,runNum,todaysdate,p0,upper_bound,lower_bound] # put all the output terms together
