...
tcur_2gen = 2 / (2 * 15100)  # ≈ 3.03e-3 = ENP, ESP ≈ 3.31e-5
...
p0 = [1.4,0.02,0.13] # initial parameters
...
output=[popt_str,scaled_popt_str,theta,ll_model,ll_data,func.__name__,mu,L,maxiter,runNum,todaysdate,p0,upper_bound,lower_bound] # put all the output terms together + changing func.func_name to func.__name__
