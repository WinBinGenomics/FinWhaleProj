...
#modelName="3D.Split"
modelName="Split-symmig-adjacent"
...
param_names=("nu1","nuA","nu2","nu3","mA","m1","m2","T1","T2")
...
func=split_symmig_adjacent # set the function
...
T1_scaled_gen = popt[7] * 2 * Nanc
T2_scaled_gen = popt[8] * 2 * Nanc
...
scaled_param_names = ("Nanc", "N1", "NA_23", "N2", "N3", "T1_gen", "T2_gen", "mA_pergen", "m1_pergen", "m2_pergen")

scaled_popt = (Nanc, nu1_scaled_dip, nuA_scaled_dip, nu2_scaled_dip, nu3_scaled_dip, T1_scaled_gen, T2_scaled_gen, mA_pergen, m1_pergen, m2_pergen)
