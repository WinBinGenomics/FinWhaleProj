...
modelName="AncestralSizeChange-Split-AsymmetricMigration"
...
upper_bound = [10, 30, 10, 10, 10, 20, 20] # 20 as upper bound on mig rec by dadi
p0 = [0.2, 2.0 ,0.10, 2.0, 2.0, 2.0, 2.0] # initial parameters
