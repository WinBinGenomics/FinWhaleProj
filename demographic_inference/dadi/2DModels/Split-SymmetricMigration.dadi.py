...
modelName="Split-SymmetricMigration"
...
def IM(params, ns, pts):
   ...
   #Two-population split-with-symmetric-migration
...
#param_names=("T","nu1","nu2","m")

#lower_bound = [1e-5, 1e-5,1e-5,1e-5]
#upper_bound = [1,10, 5,70] 
#p0 = [0.1,1.31,0.00717,2.1] # initial parameters

param_names=("T","nu1","nu2","m")
lower_bound = [0.10, 0.75, 0.75, 0.0]
upper_bound = [0.30, 5, 10, 20]

# Midpoint starting values
p0 = [0.2, 2.0, 2.0, 2.0]

func=IM # set the function
...
nu1_scaled_dip=popt[1]*Nanc

T_scaled_gen=popt[0]*2*Nanc

m_fraction=popt[3]/(2*Nanc)


scaled_param_names=("Nanc","nu1","nu2","migration","T")
scaled_popt=(Nanc,nu1_scaled_dip,nu2_scaled_dip,m_fraction, T_scaled_gen)
